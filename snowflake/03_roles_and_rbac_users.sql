...
grant usage on schema BANK_FRAUD_ANALYTICS.RAW to role TRANSFORM_ROLE;
...
grant select on all tables in schema BANK_FRAUD_ANALYTICS.RAW to role TRANSFORM_ROLE;
grant select on future tables in schema BANK_FRAUD_ANALYTICS.RAW to role TRANSFORM_ROLE;
